...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<c:url var="categoryAPI" value="/api/new"></c:url>
						...
						<div class=table-btn-controller>
							<div class="pull-right tableTools-container">								
								<div class="dt-buttons btn-overlap btn-group">
									...
									<a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" data-toggle="tooltip" title='Thêm bài viết' href="${createCategoryURL}"> <span>
										...
										<table class="table table-bordered">
											...
											<tbody>
												<c:forEach var="item" items="${model.listResult}">
													<tr>
														<td><input type="checkbox" id="checkbox_${item.code}" value="${item.code}"></td>
														<td>${item.name}</td>
														<td>		
															...
															<a class="btn btn-sm btn-primary btn-edit"
																data-toggle="tooltip" title="Cập nhật thể loại" href="${updateCategoryURL}">
